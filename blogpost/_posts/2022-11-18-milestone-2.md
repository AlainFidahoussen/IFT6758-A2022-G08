...
proprement parlé.
Par conséquence, comme constaté dans les courbes de calibration ci-dessus, ces méthodes 
...
Nous avons donc recalibrer les modèles obtenus, en utilisant [sklearn](https://scikit-learn.org/stable/modules/generated/sklearn.calibration.CalibratedClassifierCV.html#sklearn-calibration-calibratedclassifiercv){:target="_blank"}.
